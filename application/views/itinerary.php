<div id="container">
<h2 class="company-name">Itineraries</h2>
    ...
    <?php
        ...
        <div>
            <div style="width: 200px; text-align: right;float:left">
                <h3 style="width: 100px; float: right; font-family: 'Ropa Sans', sans-serif; color: #555555"><?= $pkg['title'] ?></h3>
                <p style="clear:both; font-family: Arial; color: #666666; font-size: 11px;"><?= $pkg['content'] ?></p>
            </div>
            <img src="<?= base_url()?>/public/images/<?= $pkg['img'] ?>" height="200px" style="float:left;margin:13px 0 0 13px;"/>
